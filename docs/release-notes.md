...
- Ambisonics remains intentionally reserved behind explicit positioning JSON validation and still does not render audio output, but the validated schema now carries waypoint curves and deterministic jitter-cloud parameters for future rendering work.
